...
namespace KubeMQ.Contract.Interfaces.Connections
{
    ...
    public interface IRPCCommandConnection : IConnectionBase
    {
        ...
        Task<IResultMessage<bool>> SendRPCCommand<T>(T message, string? channel = null, Dictionary<string, string>? tagCollection = null, int? timeout = null, CancellationToken cancellationToken = new CancellationToken());
