...
namespace KubeMQ.Contract.Interfaces.Connections
{
    ...
    public interface IQueueConnection : IConnectionBase
    {
        ...
        Task<ITransmissionResult> EnqueueMessage<T>(T message, string? channel = null, Dictionary<string, string>? tagCollection = null, int? expirationSeconds = null, int? delaySeconds = null, int? maxQueueSize = null, string? maxQueueChannel = null, CancellationToken cancellationToken = new CancellationToken());
        ...
        Task<IBatchTransmissionResult> EnqueueMessages<T>(IEnumerable<T> messages, string? channel = null, Dictionary<string, string>? tagCollection = null, int? expirationSeconds = null, int? delaySeconds = null, int? maxQueueSize = null, string? maxQueueChannel = null, CancellationToken cancellationToken = new CancellationToken());
